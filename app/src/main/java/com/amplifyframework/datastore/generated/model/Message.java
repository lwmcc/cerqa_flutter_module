...
public final class Message implements Model {
  ...
  private Message(String id, String content, ModelReference<Channel> channel) {
    this.id = id;
  ...
  public static class Builder implements ContentStep, BuildStep {
    ...
    private Builder(String id, String content, ModelReference<Channel> channel) {
      this.id = id;
      this.content = content;
      this.channel = channel;
    }
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String content, ModelReference<Channel> channel) {
