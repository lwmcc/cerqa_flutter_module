                ...
                AppDestination.ContactsSearch.route -> {
                    Box(
                        ...
                        TextField(
                            ...
                            label = {
                                Text(
                                    text = "User Search", //stringResource(id = R.string.user_search),
                        ...
                        if (clearSearchVisible) {
                            Icon(
                                Icons.Filled.Clear,
                                contentDescription = "To add description", // TOOD: stringResource(id = R.string.text_field_clear),
                                modifier = Modifier
                                    .align(Alignment.CenterEnd)
                                    .clickable {
                                        input = ""
                                        // TODO:  searchViewModel.onQueryChange("")
                                    },
                            )
                        }
                    }
